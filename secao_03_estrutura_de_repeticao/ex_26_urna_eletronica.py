...
def calcular_votos(*votos):
    ...
    votos_corrupto = votos.count("corrupto")
    votos_mentiroso = votos.count("mentiroso")
    votos_rouba = votos.count("rouba, mas faz")
    ...
    print(f"Votos no candidato rouba, mas faz: {votos_rouba}")
